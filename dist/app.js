...
(()=>{
    ...
    function initExplode(e) {
        e || (e = document);
        let t = e.querySelector("[data-explode]"), a = e.querySelectorAll(".u-img-to-explode"), i = a[0], l = a[1], s = a[2];
        (0, _gsapDefault.default).set(a, {
            visibility: "visible"
        ...
        (0, _gsapDefault.default).timeline({
            ...
            duration: 1,
            ease: "expo.out"
        }, 0)// .fromTo(r, { y: "0vw" }, { y: "-25vw", duration: 0.8 }, 0.1)
        .fromTo(l, {
            y: "10vw"
        }, {
            y: "0vw",
        ...
        let m = (0, _gsapDefault.default).timeline({
            defaults: {
                ease: "linear",
                duration: 1
            },
    ...
    function initPageEnd() {
        ...
        if (!el.length) return;
        el.forEach((els)=>{
            let t = els.querySelector(".spacer_wrap"), e = els.querySelector(".footer-end"), r = els.querySelector(".footer_inner"), n = els.querySelector(".footer_el.is-center");
            if (!t) return;
            let a = (0, _gsapDefault.default).timeline({
                defaults: {
                    ease: "linear"
                }
            });
            a.fromTo("#progress", {
                ...
                rotate: 0,
                duration: 1
            }, 0), (0, _scrollTriggerDefault.default).create({
                trigger: t,
                animation: a,
                start: "bottom 90%",
                endTrigger: e,
    ...
    function initHighlights(e) {
        e || (e = document);
        let t = e.querySelectorAll(".highlight-line"), o = e.querySelectorAll(".bg-line"), r = e.querySelectorAll(".intro-line"), n = e.querySelectorAll(".word");
        ...
        (0, _gsapDefault.default).fromTo(o, {
            drawSVG: "0%"
        }, {
            drawSVG: "100%",
            duration: 4,
        ...
        }), (0, _gsapDefault.default).from(o, {
            stroke: "#FFFFFF20",
            delay: 2,
            duration: 2,
            ease: "power4.inOut"
        }), (0, _gsapDefault.default).fromTo(r, {
            strokeDashoffset: -1500,
            strokeDasharray: "1600px 1500px"
        }, {
            strokeDashoffset: 1500,
            strokeDasharray: "0px 1500px",
            duration: 4,
            delay: 0,
            ease: "power3.inOut",
            stagger: {
        ...
        }), (0, _gsapDefault.default).delayedCall(1.75, ()=>{
            (0, _gsapDefault.default).fromTo(t, {
    ...
    function initBlob(e) {
        ...
        const t = {
            inner: [
                {
                    path: "M282.3 0C525.94 0 714 207.447 714 451.898C714 655.918 485.644 744 282.3 744C123.932 744 0 610.793 0 451.898C0 243.621 74.7142 0 282.3 0Z",
                    color: "#4C00FF"
                },
                {
                    path: "M375.429 0.103177C509.902 1.9222 659.452 36.7684 701.193 164.738C743.058 293.087 643.927 410.92 535.723 491.533C422.146 576.15 277.867 645.913 159.3 568.458C25.066 480.769 -35.6318 305.494 21.3907 155.542C72.0736 22.261 232.971 -1.82384 375.429 0.103177Z",
                    color: "#26065D"
                },
                {
                    path: "M373.039 13.8828C592.854 -36.1491 884 45.5798 884 315.714C884 541.171 765.716 818 540.582 818C365.244 818 0 593.613 0 418.023C0 187.863 165.6 61.0977 373.039 13.8828Z",
                    color: "#FF5252"
                }
            ],
            outer: [
                {
                    path: "M369.284 0C687.994 0 934 270.741 934 589.775C934 856.044 635.283 971 369.284 971C162.118 971 0 797.15 0 589.775C0 317.952 97.7354 0 369.284 0Z",
                    color: "#EDE5FF"
                },
                {
                    path: "M532.781 0.146025C723.616 2.72045 935.846 52.0376 995.082 233.151C1054.49 414.801 913.815 581.567 760.26 695.659C599.08 815.415 394.329 914.149 226.067 804.529C35.5718 680.424 -50.566 432.361 30.3561 220.136C102.282 31.5056 330.616 -2.58125 532.781 0.146025Z",
                    color: "#E9E6EF"
                },
                {
                    path: "M373.039 13.8828C592.854 -36.1491 884 45.5798 884 315.714C884 541.171 765.716 818 540.582 818C365.244 818 0 593.613 0 418.023C0 187.863 165.6 61.0977 373.039 13.8828Z",
        ...
        let o = (0, _gsapDefault.default).timeline({
            repeat: -1,
            repeatDelay: 0
        }), r = e.querySelector("#innerBlob"), n = e.querySelector("#outerBlob"), a = e.querySelectorAll(".u-blob-text");
        const i = 0.8, l = t.inner.length;
        t.inner.forEach((e, a)=>{
            const l = t.outer[a];
            o.to(r, {
                morphSVG: {
    ...
    window.addEventListener("DOMContentLoaded", function() {
        ...
        setTimeout(()=>{
            $("[gl-text]").each(function(index) {
                ...
                window.addEventListener("resize", function() {
                    if (windowWidth1 !== window.innerWidth) {

...
(0, _gsapDefault.default).registerPlugin((0, _gsapDefault.default), (0, _drawSVGPluginDefault.default));
// Create shorthands
...
(()=>{
    ...
    function initHighlights(e) {
        e || (e = document);
        let t = e.querySelectorAll(".highlight-line"), o = e.querySelectorAll(".bg-line"), r = e.querySelectorAll(".intro-line");
        (0, _gsapDefault.default).fromTo("#nav", {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            duration: 0.5,
    ...
    window.addEventListener("DOMContentLoaded", function() {
        ...
        $("[data-btn='wrap']").each(function() {
            ...
            $(this).on("mouseenter", function(e) {
                ...
                (0, _gsapDefault.default).set(clipEl, {
                    display: "flex"
                });
                (0, _gsapDefault.default).fromTo(clipEl, {
            ...
            $(this).on("mouseleave", function(e) {
                let percentTop = getPercentTop($(this), e);
                let percentLeft = getPercentLeft($(this), e);
                (0, _gsapDefault.default).to(clipEl, {
                    clipPath: `circle(0% at ${percentLeft}% ${percentTop}%)`,
                    overwrite: true,
                    duration: durationSetting,
                    ease: easeSetting
        ...
        cards.forEach((e)=>{
            ...
            (0, _gsapDefault.default).set(card, {
                autoAlpha: 1
            });
            (0, _gsapDefault.default).set(title, {
                autoAlpha: 1
            });
...
},{"gsap":"fPSuC","swiper":"iM6UL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap/DrawSVGPlugin":"htWnw"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
